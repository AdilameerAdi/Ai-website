-- =============================================
-- FINAL SAFE DATABASE SETUP FOR AI WEBSITE
-- This script safely creates/updates all tables and columns
-- =============================================

-- =============================================
-- STEP 1: Create missing tables with all columns
-- =============================================
...
-- Add action_url column to notifications if it doesn't exist
DO $$ 
BEGIN 
...
-- Add expires_at column to notifications if it doesn't exist
DO $$ 
BEGIN 
...
ALTER TABLE IF EXISTS proposal_line_items DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS user_activities DISABLE ROW LEVEL SECURITY;
...
-- =============================================
-- STEP 5: Insert initial system settings
-- =============================================
...
-- =============================================
-- STEP 7: Create indexes safely (without failing)
-- =============================================
...
-- Notifications indexes (only after columns exist)
...
SELECT 'Final safe database setup completed successfully!' as status;
...
SELECT 'User activities has metadata column:' as info;
SELECT EXISTS (
    SELECT 1 FROM information_schema.columns 
    WHERE table_name = 'user_activities' AND column_name = 'metadata'
) as has_metadata_column;

-- Verify notifications has required columns
