...
export default function DemoModal({ isOpen, onClose }) {
  const [formData, setFormData] = useState({
    ...
    companySize: "",
    currentSolution: "",
    interestedIn: "Full Platform Demo",
    message: ""
  });
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800">Request Demo</h2>
          <button
            onClick={handleClose}
          ...
          {submitted ? (
            ...
            <>
              ...
              <select
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#14B8A6]"
              >
                <option value="Full Platform Demo">Full Platform Demo</option>
                <option value="ConsecDesk Only">ConsecDesk - Support System</option>
                <option value="ConsecDrive Only">ConsecDrive - File Management</option>
                <option value="ConsecQuote Only">ConsecQuote - Proposal System</option>
                <option value="Custom Solution">Custom Solution Discussion</option>
              </select>
