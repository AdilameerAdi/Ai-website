...
('welcome_email', 'Welcome!', '<h1>Welcome!</h1>', 'Welcome!', 'auth', true),
('proposal_created', 'Proposal Created', '<h1>Proposal Created</h1>', 'Proposal Created', 'proposals', true),
('ticket_created', 'Ticket Created', '<h1>Ticket Created</h1>', 'Ticket Created', 'support', true);
