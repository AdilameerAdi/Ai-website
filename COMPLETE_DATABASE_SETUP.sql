-- =============================================
-- COMPLETE DATABASE SETUP FOR AI WEBSITE
-- This script creates ALL tables needed for the application
-- Run this script once to set up your entire database
-- =============================================
...
DROP POLICY IF EXISTS "Enable all access for users on own proposals" ON proposals;
DROP POLICY IF EXISTS "Enable all access for proposal line items" ON proposal_line_items;
DROP POLICY IF EXISTS "Enable all access for users on own activities" ON user_activities;
...
-- =============================================
-- STEP 7: Create files table (ConsecDrive)
-- =============================================
...
-- =============================================
-- STEP 11: Create user_activities table
-- =============================================
...
-- =============================================
-- STEP 15: Create system_settings table
-- =============================================
...
-- =============================================
-- STEP 17: Disable Row Level Security for development
-- =============================================
...
-- =============================================
-- STEP 19: Insert initial system data
-- =============================================

-- Create initial user with correct ID
INSERT INTO users (
    id,
    email,
    full_name,
...
('site_description', '"Complete business management platform with AI integration"', 'Site description for SEO', 'general', true),
('max_file_size', '52428800', 'Maximum file upload size in bytes (50MB)', 'files', false),
('allowed_file_types', '["pdf", "doc", "docx", "txt", "jpg", "jpeg", "png", "gif"]', 'Allowed file types for upload', 'files', false),
...
('default_user_storage_limit', '5368709120', 'Default storage limit for new users (5GB)', 'users', false);
...
-- =============================================
-- STEP 21: Create views for common queries
-- =============================================
...
GROUP BY u.id, u.full_name, u.email, u.storage_limit, u.subscription_plan, u.last_login;
...
SELECT 
    ...
    (SELECT COUNT(*) FROM proposals WHERE status = 'sent') as sent_proposals,
...
-- =============================================
-- STEP 22: Verification and final status
-- =============================================
...
SELECT 'Initial data verification:' as message;
SELECT 
...
SELECT 'Database setup completed successfully! All tables, indexes, triggers, views, and initial data have been created.' as final_status;