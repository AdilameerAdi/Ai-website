-- Simple fix for files table - just add missing columns without UPDATE
...
SELECT 'Files table columns after adding missing ones:' as info;
SELECT column_name 
FROM information_schema.columns 
WHERE table_name = 'files'
ORDER BY column_name;

SELECT 'Simple files fix completed successfully!' as status;